			 ...
			 <div class="row form-group">
               <div class="col-md-12">
                  <label class="text-black">고객ID </label> 
                  	...
                  	<input type = hidden name = "customerID" value = <%= contract.getCustomerID()%>>	
               </div>         
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="date" name ="paymentDate" value= "<%= contract.getPaymentDate()%>" class="form-control">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type=date name ="contractExpirationDate" value= "<%= contract.getContractExpirationDate()%>" class="form-control">            
                 </div>                 
               </div>
